...
public class MachineRecipe {
        ...
        public static void init(Consumer<FinishedRecipe> provider) {
                ...
                for (int tier : GTValues.tiersBetween(GTValues.LV, GTValues.HV)) {
                        ASSEMBLER_RECIPES
                                        .recipeBuilder(GTMThings.id("wireless_energy_input_hatch_"
                                                        + GTValues.VN[tier].toLowerCase() + "_4a"))
                        ...
                        ASSEMBLER_RECIPES
                                        .recipeBuilder(GTMThings.id("wireless_energy_input_hatch_"
                                                        + GTValues.VN[tier].toLowerCase() + "_16a"))
                        ...
                        ASSEMBLER_RECIPES
                                        .recipeBuilder(GTMThings.id("wireless_energy_output_hatch_"
                                                        + GTValues.VN[tier].toLowerCase() + "_4a"))
                ...
                for (int tier : GTValues.tiersBetween(GTValues.EV, GTValues.MAX)) {
                        ASSEMBLER_RECIPES
                                        .recipeBuilder(GTMThings.id("wireless_energy_input_hatch_"
                                                        + GTValues.VN[tier].toLowerCase() + "_64a"))
                ...
                ASSEMBLER_RECIPES
                                .recipeBuilder(GTMThings.id("wireless_energy_input_hatch_"
                                                + GTValues.VN[MAX].toLowerCase() + "_4a"))
                ...
                ASSEMBLER_RECIPES
                                .recipeBuilder(GTMThings.id("wireless_energy_input_hatch_"
                                                + GTValues.VN[MAX].toLowerCase() + "_16a"))
                ...
                ASSEMBLER_RECIPES
                                .recipeBuilder(GTMThings.id("wireless_energy_input_hatch_"
                                                + GTValues.VN[MAX].toLowerCase() + "_256a"))
                ...
                ASSEMBLER_RECIPES
                                .recipeBuilder(GTMThings.id("wireless_energy_input_hatch_"
                                                + GTValues.VN[MAX].toLowerCase() + "_1024a"))
                ...
                ASSEMBLER_RECIPES
                                .recipeBuilder(GTMThings.id("wireless_energy_input_hatch_"
                                                + GTValues.VN[MAX].toLowerCase() + "_4096a"))
