...
public class PlatGroupMetalsRecipesMixin {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("pgs_separation").duration(20).EUt(VA[HV])
        ...
        DISTILLATION_RECIPES.recipeBuilder("acidic_osmium_solution_separation").duration(80).EUt(VA[LV])
